...
insert into users (username, first_name, last_name, password, age) values ( ' ', 'Marek', 'Lubczyk', '$2a$10$1h4cnaVllPQjO5EzPBiud.b7UQGR.upA6wBgGVNDqgskRA.0TjTDu',44);

insert into roles (name) VALUES ( 'ROLE_USER' ), ('ROLE_ADMIN');

insert into user_roles (user_id, role_id) values ( 1, 1 ), (2, 1), (3, 2), (3, 1);
